    ...
    <x-filament::section>
        ...
        <div class="text-center space-y-6">
            ...
            @if($todayAttendence)
                            ...
                            <x-filament::card>
                                <div style="text-align: center; padding: 1rem;">
                                    ...
                                    <p style="font-size: 1.5rem; font-weight: 700; color: rgb(34 197 94);">
                                        {{ $todayAttendence->check_in?->format('h:i A') ?? 'Not checked in' }}
                                    </p>
                                </div>
                            </x-filament::card>
                            ...
                            <x-filament::card>
                                <div style="text-align: center; padding: 1rem;">
                                    ...
                                    <p style="font-size: 1.5rem; font-weight: 700; color: rgb(239 68 68);">
                                        {{ $todayAttendence->check_out?->format('h:i A') ?? 'Not checked out' }}
                                    </p>
                                </div>
                            </x-filament::card>
                        </div>
                ...
                @if($todayAttendence->check_in && $todayAttendence->check_out)
                    <x-filament::card>
                        <div style="text-align: center;">
                            ...
                            <p style="font-size: 1.875rem; font-weight: 700; color: rgb(59 130 246);">
                                {{ $todayAttendence->check_in->diff($todayAttendence->check_out)->format('%H:%I:%S') }}
                            </p>
                        </div>
                    </x-filament::card>
                @endif
                ...
                <x-filament::card>
                    <div style="text-align: center; padding: 2rem;">
                        ...
                        <p style="font-size: 0.875rem; color: rgb(156 163 175); margin-top: 0.5rem;">
                            Click the "Check In" button above to mark your Attendence
                        </p>
                    </div>
                </x-filament::card>
            @endif
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    <x-filament::card>
                        <div style="text-align: center;">
                            ...
                            <p style="font-size: 1.5rem; font-weight: 700; color: rgb(34 197 94);">
                                {{ \App\Models\Attendence::where('user_id', auth()->id())
